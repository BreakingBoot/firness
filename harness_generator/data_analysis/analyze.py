...
def analyze_data(macro_file: str, 
                 ...
                 alias_file: str, 
                 random: bool,
                 harness_folder: str) -> Tuple[Dict[str, FunctionBlock], Dict[str, FunctionBlock], Dict[str, FunctionBlock], Dict[str, List[FieldInfo]], List[str], Dict[str, str], Dict[str, str], set, set]:
    ...
    data, function_template = load_data(
        data_file, harness_functions, macros_val)
